...
// Custom Contracts
//
// With the web3sdks SDK, you can get a contract instance for any contract. Additionally,
// if you deployed your contract using web3sdks deploy, you can get a more explicit and
...
// deployed using the web3sdks deploy flow:
//
//	import (
...
//
// Alternatively, if you didn't deploy your contract with web3sdks deploy, you can still get a
