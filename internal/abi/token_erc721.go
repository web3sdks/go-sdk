...
func (_TokenERC721 *TokenERC721Caller) Web3sdksFee(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _TokenERC721.contract.Call(opts, &out, "web3sdksFee")
...
//
// Solidity: function web3sdksFee() view returns(address)
func (_TokenERC721 *TokenERC721Session) Web3sdksFee() (common.Address, error) {
	return _TokenERC721.Contract.Web3sdksFee(&_TokenERC721.CallOpts)
}

// Web3sdksFee is a free data retrieval call binding the contract method 0xcf8267b1.
//
// Solidity: function web3sdksFee() view returns(address)
func (_TokenERC721 *TokenERC721CallerSession) Web3sdksFee() (common.Address, error) {
	return _TokenERC721.Contract.Web3sdksFee(&_TokenERC721.CallOpts)
}
