...
func (_Marketplace *MarketplaceCaller) Web3sdksFee(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _Marketplace.contract.Call(opts, &out, "web3sdksFee")
...
//
// Solidity: function web3sdksFee() view returns(address)
func (_Marketplace *MarketplaceSession) Web3sdksFee() (common.Address, error) {
	return _Marketplace.Contract.Web3sdksFee(&_Marketplace.CallOpts)
}

// Web3sdksFee is a free data retrieval call binding the contract method 0xcf8267b1.
//
// Solidity: function web3sdksFee() view returns(address)
func (_Marketplace *MarketplaceCallerSession) Web3sdksFee() (common.Address, error) {
	return _Marketplace.Contract.Web3sdksFee(&_Marketplace.CallOpts)
}
