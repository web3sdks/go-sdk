...
// Web3sdksFee is a free data retrieval call binding the contract method 0xcf8267b1.
//
// Solidity: function web3sdksFee() view returns(address)
func (_TokenERC1155 *TokenERC1155Caller) Web3sdksFee(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _TokenERC1155.contract.Call(opts, &out, "web3sdksFee")
...
//
// Solidity: function web3sdksFee() view returns(address)
func (_TokenERC1155 *TokenERC1155Session) Web3sdksFee() (common.Address, error) {
	return _TokenERC1155.Contract.Web3sdksFee(&_TokenERC1155.CallOpts)
}

// Web3sdksFee is a free data retrieval call binding the contract method 0xcf8267b1.
//
// Solidity: function web3sdksFee() view returns(address)
func (_TokenERC1155 *TokenERC1155CallerSession) Web3sdksFee() (common.Address, error) {
	return _TokenERC1155.Contract.Web3sdksFee(&_TokenERC1155.CallOpts)
}
